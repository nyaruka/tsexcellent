...
export class Excellent2Parser extends Parser {
	...
	private static readonly _SYMBOLIC_NAMES: Array<string | undefined> = [
		undefined, "COMMA", "LPAREN", "RPAREN", "LBRACK", "RBRACK", "DOT", "PLUS", 
		"MINUS", "TIMES", "DIVIDE", "EXPONENT", "EQ", "NEQ", "LTE", "LT", "GTE", 
		"GT", "AMPERSAND", "TEXT", "NUMBER", "TRUE", "FALSE", "NULL", "NAME", 
		"WS", "ERROR",
	];
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(Excellent2Parser._LITERAL_NAMES, Excellent2Parser._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get grammarFileName(): string { return "Excellent2.g4"; }

	// @Override
	public get ruleNames(): string[] { return Excellent2Parser.ruleNames; }

	// @Override
	public get serializedATN(): string { return Excellent2Parser._serializedATN; }
	...
	public atom(_p?: number): AtomContext {
		...
		try {
			...
			case 1:
				...
				if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << Excellent2Parser.LPAREN) | (1 << Excellent2Parser.MINUS) | (1 << Excellent2Parser.TEXT) | (1 << Excellent2Parser.NUMBER) | (1 << Excellent2Parser.TRUE) | (1 << Excellent2Parser.FALSE) | (1 << Excellent2Parser.NULL) | (1 << Excellent2Parser.NAME))) !== 0)) {
					{
					this.state = 16;
					this.parameters();
					}
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, Excellent2Parser.RULE_atom);
						this.state = 29;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, Excellent2Parser.RULE_expression);
						this.state = 52;
						if (!(this.precpred(this._ctx, 7))) {
							throw new FailedPredicateException(this, "this.precpred(this._ctx, 7)");
						}
					...
					case 2:
						...
						this.state = 56;
						(_localctx as MultiplicationOrDivisionContext)._op = this._input.LT(1);
						_la = this._input.LA(1);
						if (!(_la === Excellent2Parser.TIMES || _la === Excellent2Parser.DIVIDE)) {
							(_localctx as MultiplicationOrDivisionContext)._op = this._errHandler.recoverInline(this);
						} else {
					...
					case 3:
						...
						this.state = 59;
						(_localctx as AdditionOrSubtractionContext)._op = this._input.LT(1);
						_la = this._input.LA(1);
						if (!(_la === Excellent2Parser.PLUS || _la === Excellent2Parser.MINUS)) {
							(_localctx as AdditionOrSubtractionContext)._op = this._errHandler.recoverInline(this);
						} else {
							if (this._input.LA(1) === Token.EOF) {
								this.matchedEOF = true;
							}
					...
					case 4:
						...
						_la = this._input.LA(1);
						if (!((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << Excellent2Parser.LTE) | (1 << Excellent2Parser.LT) | (1 << Excellent2Parser.GTE) | (1 << Excellent2Parser.GT))) !== 0))) {
					...
					case 5:
						...
						_la = this._input.LA(1);
						if (!(_la === Excellent2Parser.EQ || _la === Excellent2Parser.NEQ)) {
	...
	public static get _ATN(): ATN {
		if (!Excellent2Parser.__ATN) {
			Excellent2Parser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(Excellent2Parser._serializedATN));
		}
...
export class ParseContext extends ParserRuleContext {
	...
	public EOF(): TerminalNode { return this.getToken(Excellent2Parser.EOF, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return Excellent2Parser.RULE_parse; }
	// @Override
...
export class AtomContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return Excellent2Parser.RULE_atom; }
...
export class DotLookupContext extends AtomContext {
	...
	public DOT(): TerminalNode { return this.getToken(Excellent2Parser.DOT, 0); }
...
export class NullContext extends AtomContext {
	public NULL(): TerminalNode { return this.getToken(Excellent2Parser.NULL, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class FunctionCallContext extends AtomContext {
	...
	public LPAREN(): TerminalNode { return this.getToken(Excellent2Parser.LPAREN, 0); }
	public RPAREN(): TerminalNode { return this.getToken(Excellent2Parser.RPAREN, 0); }
...
export class TrueContext extends AtomContext {
	public TRUE(): TerminalNode { return this.getToken(Excellent2Parser.TRUE, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class FalseContext extends AtomContext {
	public FALSE(): TerminalNode { return this.getToken(Excellent2Parser.FALSE, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ArrayLookupContext extends AtomContext {
	...
	public LBRACK(): TerminalNode { return this.getToken(Excellent2Parser.LBRACK, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
	public RBRACK(): TerminalNode { return this.getToken(Excellent2Parser.RBRACK, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ContextReferenceContext extends AtomContext {
	public NAME(): TerminalNode { return this.getToken(Excellent2Parser.NAME, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class TextLiteralContext extends AtomContext {
	public TEXT(): TerminalNode { return this.getToken(Excellent2Parser.TEXT, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class NumberLiteralContext extends AtomContext {
	public NUMBER(): TerminalNode { return this.getToken(Excellent2Parser.NUMBER, 0); }
	constructor(ctx: AtomContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ExpressionContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return Excellent2Parser.RULE_expression; }
...
export class NegationContext extends ExpressionContext {
	public MINUS(): TerminalNode { return this.getToken(Excellent2Parser.MINUS, 0); }
	public expression(): ExpressionContext {
		return this.getRuleContext(0, ExpressionContext);
	}
	constructor(ctx: ExpressionContext) {
...
export class ComparisonContext extends ExpressionContext {
	...
	public LTE(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.LTE, 0); }
	public LT(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.LT, 0); }
	public GTE(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.GTE, 0); }
	public GT(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.GT, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ConcatenationContext extends ExpressionContext {
	...
	public AMPERSAND(): TerminalNode { return this.getToken(Excellent2Parser.AMPERSAND, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class MultiplicationOrDivisionContext extends ExpressionContext {
	...
	public TIMES(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.TIMES, 0); }
	public DIVIDE(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.DIVIDE, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class AdditionOrSubtractionContext extends ExpressionContext {
	...
	public PLUS(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.PLUS, 0); }
	public MINUS(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.MINUS, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class EqualityContext extends ExpressionContext {
	...
	public EQ(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.EQ, 0); }
	public NEQ(): TerminalNode | undefined { return this.tryGetToken(Excellent2Parser.NEQ, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class ExponentContext extends ExpressionContext {
	...
	public EXPONENT(): TerminalNode { return this.getToken(Excellent2Parser.EXPONENT, 0); }
	constructor(ctx: ExpressionContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class FnnameContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return Excellent2Parser.RULE_fnname; }
	// @Override
	public enterRule(listener: Excellent2Listener): void {
...
export class ParametersContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return Excellent2Parser.RULE_parameters; }
