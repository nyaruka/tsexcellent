...
export class Excellent2Lexer extends Lexer {
	...
	public static readonly ruleNames: string[] = [
		...
		"AMPERSAND", "TEXT", "NUMBER", "TRUE", "FALSE", "NULL", "NAME", "WS", 
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(Excellent2Lexer._LITERAL_NAMES, Excellent2Lexer._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get ruleNames(): string[] { return Excellent2Lexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return Excellent2Lexer._serializedATN; }

	// @Override
	public get modeNames(): string[] { return Excellent2Lexer.modeNames; }
	...
	public static get _ATN(): ATN {
		if (!Excellent2Lexer.__ATN) {
			Excellent2Lexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(Excellent2Lexer._serializedATN));
		}
